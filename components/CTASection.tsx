                    ...
                    <div className="bg-gradient-to-br from-medical-blue to-medical-green rounded-3xl p-16 shadow-2xl shadow-medical-blue/20 relative overflow-hidden">
                        ...
                        <div className="relative">
                            ...
                            <div className="flex flex-wrap gap-4 justify-center">
                                <Link to="/auth" state={{ mode: 'signup' }} className="px-8 py-4 rounded-full bg-white text-medical-blue font-bold shadow-xl hover:shadow-2xl hover:scale-105 transition-all text-center">
                                    Get Started Free
                                </Link>
                                <button className="px-8 py-4 rounded-full bg-white/20 text-white font-bold border-2 border-white/40 hover:bg-white/30 transition-all text-center">
                                    Download App
                                </button>
                            </div>
                        </div>
