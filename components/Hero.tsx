            ...
            <div className="relative max-w-7xl mx-auto px-6 py-24 grid lg:grid-cols-2 gap-16 items-center">
                ...
                >
                    ...
                    <FadeUp delay={0.3} className="flex flex-wrap gap-4">
                        <Link to="/auth" state={{ mode: 'signup' }} className="group flex items-center gap-2 px-8 py-4 rounded-full bg-gradient-to-r from-medical-blue to-medical-green text-white font-semibold shadow-xl shadow-medical-blue/20 hover:shadow-medical-blue/30 hover:scale-105 transition-all">
                            Get Started
